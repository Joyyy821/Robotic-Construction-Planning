classdef mainUIv3_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function success = loadData(app)
            ...
            app.Num_robot = length(Robot_pos);
...
%                         'FaceAlpha', app.Target_alpha);
                    ...
                    item_h = rectangle(axis, "FaceColor", app.Color_list(1), ...
                        "EdgeColor", "none", ...
                        "Position", [pos, pos(1)+rob_x, pos(2)+rob_y]);
...
%                 set(app.GridSwitch, 'BackgroundColor', 'g');
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = mainUIv3_exported
